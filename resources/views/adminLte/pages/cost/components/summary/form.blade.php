    ...
    <div class="row">
        ...
        <div class="col-2">
            <div class="form-group">
                ...
                <input type="text" value="{{ $type_form == 'edit' ? $data->material_cost : 0 }}" class="form-control form-control-sm" readonly id="summary_material_cost">
            </div>
        </div>
        <div class="col-2">
            <div class="form-group">
                <label for="summary_process_cost" class="col-form-label label-grey">{{ __('view.process_cost_calculate_title') }}</label>
                <input type="text" value="{{ $type_form == 'edit' ? $data->process_cost : 0 }}" class="form-control form-control-sm" readonly id="summary_process_cost">
            </div>
        </div>
        <div class="col-2">
            <div class="form-group">
                <label for="summary_purchase_cost" class="col-form-label label-grey">{{ __('view.purchase_cost_calculate_title') }}</label>
                <input type="text" value="{{ $type_form == 'edit' ? $data->purchase_cost : 0 }}" class="form-control form-control-sm" readonly id="summary_purchase_cost">
            </div>
        </div>
        <div class="col-2">
            <div class="form-group">
                <label for="summary_total_cost" class="col-form-label label-grey">{{ __('view.total') }}</label>
                <input type="number" value="{{ $type_form == 'edit' ? $data->total_cost : 0 }}" class="form-control form-control-sm cost-disabled" readonly id="summary_total_cost">
            </div>
        </div>
    </div>
</div>