...
class MaterialController extends Controller
{
    ...
    public function store(Request $request, $type)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json(['message' => 'Success create material']);
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json(['message' => 'Success update material']);
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json(['message' => 'Success delete material']);
        } catch (\Throwable $th) {
            DB::rollBack();
            return response()->json(['message' => $th->getMessage()]);
        }
